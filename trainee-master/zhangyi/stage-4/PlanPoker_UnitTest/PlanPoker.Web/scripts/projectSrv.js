mainApp.service("projectService", ['$http', function ($http) {
    ...
    this.initProjectListSelect = function ($scope) {
        $http({
            method: "Get",
            url: apiPath() + "/api/project"
        }).success(function (data) {
            $scope.projectList.options = data;
            ...
            $http({
                ...
                $scope.href = '/views/ProjectEstimate.html?presenter=1&projectGuid=' + data2;
    ...
    this.InitProjectListTable = function ($scope) {
        $http({
            method: "Get",
            url: apiPath() + "/api/project"
        }).success(function (data) {
