...
namespace PlanPoker.Logic.Test
{
    ...
    public class UserLogicTest
    {
        ...
        private PlanPokerUser _userEntity;
        private List<PlanPokerUser> _userEntities;
        [SetUp]
        public void Init()
        {
        ...
        public void GetAll_should_call_query_method_of_user_repository_once_return_all_users()
        {
            ...
            _userEntities = new List<PlanPokerUser> {_userEntity};
        ...
        public void Create_should_call_create_method_of_user_repository_once_return_userId()
        {
            ...
            //Assert
            _userRepositoryMock.Verify(x => x.Create(It.IsAny<PlanPokerUser>()), Times.Once);
        ...
        public void Edit_should_call_edit_method_of_user_repository_once()
        {
            ...
            //Assert
            _userRepositoryMock.Verify(x => x.Edit(It.IsAny<PlanPokerUser>()), Times.Once);
        }
