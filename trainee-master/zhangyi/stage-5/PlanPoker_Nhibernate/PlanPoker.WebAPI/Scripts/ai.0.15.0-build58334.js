...
(function (AI) {
    ...
    var ContextTagKeys = (function () {
        function ContextTagKeys() {
            ...
            this.userAccountAcquisitionDate = "ai.PlanPokerUser.accountAcquisitionDate";
            this.userAccountId = "ai.PlanPokerUser.accountId";
            this.userAgent = "ai.PlanPokerUser.userAgent";
            this.userId = "ai.PlanPokerUser.id";
            this.userStoreRegion = "ai.PlanPokerUser.storeRegion";
            this.userAuthUserId = "ai.PlanPokerUser.authUserId";
            this.userAnonymousUserAcquisitionDate = "ai.PlanPokerUser.anonUserAcquisitionDate";
            this.userAuthenticatedUserAcquisitionDate = "ai.PlanPokerUser.authUserAcquisitionDate";
        ...
        (function (Context) {
            ...
            var User = (function () {
                ...
                User.prototype.setAuthenticatedUserContext = function (authenticatedUserId, accountId) {
                    ...
                    if (isInvalidInput) {
                        ApplicationInsights._InternalLogging.throwInternalUserActionable(1 /* WARNING */, "Setting auth PlanPokerUser context failed. " + "PlanPokerUser auth/account id should be of type string, and not contain commas, semi-colons, equal signs, spaces, or vertical-bars.");
                        return;
                    }
        ...
        var AppInsights = (function () {
            ...
            AppInsights.prototype.setAuthenticatedUserContext = function (authenticatedUserId, accountId) {
                try {
                    ...
                    ApplicationInsights._InternalLogging.throwInternalUserActionable(1 /* WARNING */, "Setting auth PlanPokerUser context failed. " + ApplicationInsights.Util.dump(e));
                }
            };
            AppInsights.prototype.clearAuthenticatedUserContext = function () {
                try {
                    ...
                    ApplicationInsights._InternalLogging.throwInternalUserActionable(1 /* WARNING */, "Clearing auth PlanPokerUser context failed. " + ApplicationInsights.Util.dump(e));
                }
            };
