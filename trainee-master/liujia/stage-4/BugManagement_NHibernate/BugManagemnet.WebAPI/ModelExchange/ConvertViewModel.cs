...
namespace BugManagemnet.WebAPI.ModelExchange
{
    public static class ConvertViewModel
    {
        ...
        {
            return bugLogicModels != null &&  bugLogicModels.Any()
        ...
        {
            return developerLogicModels != null && developerLogicModels.Any()
        ...
        {
            return developerViewModels != null && developerViewModels.Any()
