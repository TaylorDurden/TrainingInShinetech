...
(function (AI) {
    ...
    var ContextTagKeys = (function () {
        function ContextTagKeys() {
            ...
            this.deviceModel = "ai.device.logicLogicModel";
            ...
            this.userAccountAcquisitionDate = "ai.UserViewModel.accountAcquisitionDate";
            this.userAccountId = "ai.UserViewModel.accountId";
            this.userAgent = "ai.UserViewModel.userAgent";
            this.userId = "ai.UserViewModel.id";
            this.userStoreRegion = "ai.UserViewModel.storeRegion";
            this.userAuthUserId = "ai.UserViewModel.authUserId";
            this.userAnonymousUserAcquisitionDate = "ai.UserViewModel.anonUserAcquisitionDate";
            this.userAuthenticatedUserAcquisitionDate = "ai.UserViewModel.authUserAcquisitionDate";
        ...
        (function (Context) {
            ...
            var User = (function () {
                ...
                User.prototype.setAuthenticatedUserContext = function (authenticatedUserId, accountId) {
                    ...
                    if (isInvalidInput) {
                        ApplicationInsights._InternalLogging.throwInternalUserActionable(1 /* WARNING */, "Setting auth UserViewModel context failed. " + "UserViewModel auth/account id should be of type string, and not contain commas, semi-colons, equal signs, spaces, or vertical-bars.");
                        return;
                    }
        ...
        var AppInsights = (function () {
            ...
            AppInsights.prototype.setAuthenticatedUserContext = function (authenticatedUserId, accountId) {
                try {
                    ...
                    ApplicationInsights._InternalLogging.throwInternalUserActionable(1 /* WARNING */, "Setting auth UserViewModel context failed. " + ApplicationInsights.Util.dump(e));
                }
            };
            AppInsights.prototype.clearAuthenticatedUserContext = function () {
                try {
                    ...
                    ApplicationInsights._InternalLogging.throwInternalUserActionable(1 /* WARNING */, "Clearing auth UserViewModel context failed. " + ApplicationInsights.Util.dump(e));
                }
            };
